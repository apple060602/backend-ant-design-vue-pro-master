export default {
  ...
  'user.login.tab-login-credentials': '电脑登入',
  'user.login.tab-login-mobile': '手机登入',
  'user.login.mobile.placeholder': '手机登入',
  ...
  'user.userName.required': '请输入账号名称或垫子邮件地址!',
  'user.password.required': '请输入你的密码!',
